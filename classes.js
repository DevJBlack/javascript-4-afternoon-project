...
class ProgressiveManager extends Manager{
  ...
  hire(){
    super.hire()
     let managerTitle = this.reports.length
     if(managerTitle === 0){
       this.title = 'Not a manager'
     } else if(managerTitle >= 1 && managerTitle <= 3){
       this.title ='Barely Manager'
     } else if(managerTitle >= 4 && managerTitle <= 10){
      this.title = 'Mostly Manager'
     } else if(managerTitle >= 11 && managerTitle <= 50){
       this.title = 'Manager'
     } else if(managerTitle >= 51 && managerTitle <= 100){
       this.title = 'Manager Plus'
     } else if(managerTitle >= 101){
